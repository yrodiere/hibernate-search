	...
	public void setup() {
		...
		mapping = setupHelper.start()
				.withConfiguration( b -> {
					...
					indexedEntityMapping.property( "propertyWithFieldDeclaredInParentThenGetterInChild" )
							.genericField();
					indexedEntityMapping.property( "propertyWithGetterAndFieldDeclaredInParentThenOverridden" )
							.genericField();
