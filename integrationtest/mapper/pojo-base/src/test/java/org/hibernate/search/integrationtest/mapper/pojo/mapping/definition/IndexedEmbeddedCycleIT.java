	...
	public void cycle() {
		...
		assertThatThrownBy( () -> setupHelper.start()
				...
				.satisfies( FailureReportUtils.hasFailureReport()
						...
						.failure(
								"Cyclic @IndexedEmbedded recursion starting from type '" + Model.EntityA.class.getName() + "'",
	...
	public void cycle_nonRoot() {
		...
		assertThatThrownBy( () -> setupHelper.start()
				...
				.satisfies( FailureReportUtils.hasFailureReport()
						...
						.failure(
								"Cyclic @IndexedEmbedded recursion starting from type '" + Model.EntityB.class.getName() + "'",
	...
	public void cycle_selfReferenceWontBreak_excludeSomePropertyNotInCycle() {
		...
		assertThatThrownBy( () -> setupHelper.start()
				...
				.satisfies( FailureReportUtils.hasFailureReport()
						...
						.failure(
								"Cyclic @IndexedEmbedded recursion starting from type '" + EntityA.class.getName() + "'",
								"Path starting from that type and ending with a cycle: 'a.a.a.'",
								"A type cannot declare an unrestricted @IndexedEmbedded to itself, even indirectly",
								"To break the cycle, you should consider adding filters to your @IndexedEmbedded: includePaths, includeDepth, excludePaths, ..."
						)
				);
