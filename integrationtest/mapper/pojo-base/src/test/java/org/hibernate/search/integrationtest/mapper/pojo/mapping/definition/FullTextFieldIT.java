...
public class FullTextFieldIT {
	...
	public void searchable() {
		...
		backendMock.expectSchema( INDEX_NAME, b -> b
				.field( "searchable", String.class, f -> f.analyzerName( AnalyzerNames.DEFAULT ).searchable(
						Searchable.YES ) )
				.field( "unsearchable", String.class, f -> f.analyzerName( AnalyzerNames.DEFAULT ).searchable(
						Searchable.NO ) )
	...
	public void termVector() {
		...
		backendMock.expectSchema( INDEX_NAME, b -> b
				.field( "termVector", String.class, f -> f.analyzerName( AnalyzerNames.DEFAULT ).termVector(
						TermVector.YES ) )
				.field( "noTermVector", String.class, f -> f.analyzerName( AnalyzerNames.DEFAULT ).termVector(
						TermVector.NO ) )
				.field( "moreOptions", String.class, f -> f.analyzerName( AnalyzerNames.DEFAULT ).termVector(
