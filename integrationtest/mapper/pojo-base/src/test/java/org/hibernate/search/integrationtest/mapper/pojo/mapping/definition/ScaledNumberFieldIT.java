...
public class ScaledNumberFieldIT {
	...
	public void customBridge_explicitFieldType() {
		...
		class IndexedEntity {
			@DocumentId
			Integer id;
			@ScaledNumberField(decimalScale = 3, valueBinder = @ValueBinderRef(
	...
	public void customBridge_withParams_annotationMapping() {
		...
		class IndexedEntity {
			@DocumentId
			Integer id;
			@ScaledNumberField(decimalScale = 2, valueBinder = @ValueBinderRef(
					type = ParametricBridge.ParametricBinder.class,
					params = {
	...
	public void customBridge_explicitFieldType_invalid() {
		...
		class IndexedEntity {
			...
			Integer id;
			@ScaledNumberField(decimalScale = 3, valueBinder = @ValueBinderRef(
					type = InvalidTypeBridge.ExplicitFieldTypeBinder.class))
			WrappedValue wrap;
		}
