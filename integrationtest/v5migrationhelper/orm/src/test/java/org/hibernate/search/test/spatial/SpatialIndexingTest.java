...
public class SpatialIndexingTest extends SearchTestBase {
	...
	public void createAndIndexTestData() throws Exception {
		...
		//DoubleIndexedPOIs
		fullTextSession.save( new DoubleIndexedPOI( 1, "Davide D'Alto", 37.780392d, -122.513898d,
	...
	public void testDistanceProjection() throws Exception {
		...
		hibQuery.setSort( builder.sort().byDistance().onField( "location" ).fromLatitude( centerLatitude ).andLongitude(
				centerLongitude ).createSort() );
	...
	public void test180MeridianCross() throws Exception {
		...
		final QueryBuilder builder = fullTextSession.getSearchFactory().buildQueryBuilder().forEntity(
