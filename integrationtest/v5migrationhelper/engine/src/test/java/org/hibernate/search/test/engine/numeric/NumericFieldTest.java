...
public class NumericFieldTest {
	...
	public void testIndexAndSearchNumericField() {
		...
		assertRangeQuery( "fallbackImportance", Short.valueOf( "11" ), Short.valueOf( "13" ) ).as(
				"Query by Short range" ).hasResultSize( 3 );
		...
		assertRangeQuery( "overriddenFieldName", 1, 3, true, false ).as( "Query by id excluding upper" ).hasResultSize(
				2 );
	...
	private void prepareData() {
		...
		Location loc3 = new Location( 3, 3L, 0d, -20d, 1, "A text", 0.86d, countryFor( "Brazil", 0.813 ), (short) 12,
				(byte) 22 );
		Location loc4 = new Location( 4, 4L, 10d, 0d, 2, "Any text", 0.99d, countryFor( "France", 0.872 ), (short) 13,
				(byte) 23 );
		Location loc5 = new Location( 5, 5L, 20d, 20d, 3, "Random text", 0.1d, countryFor( "India", 0.612 ), (short) 14,
				(byte) 24 );
