...
public abstract class AbstractProjectionInObjectProjectionIT<F, P, V extends AbstractProjectionTestValues<F, P>> {
	...
	public void fieldOutsideObjectFieldTree() {
		assertThatThrownBy( () -> mainIndex.query()
				...
				.hasMessageContainingAll(
						...
						"the surrounding projection is executed for each object in field '"
								+ level2Path()
								+ "',"
								+ " which is not a parent of field '"
								+ level1SingleValuedFieldPath()
								+ "'",
	...
	public void singleValuedField_effectivelyMultiValuedInContext() {
		assertThatThrownBy( () -> mainIndex.query()
				...
				.hasMessageContainingAll(
						...
						"call '.multi()' when you create the projection on field '"
								+ level2SingleValuedFieldPath()
								+ "'",
						"or wrap that projection in an object projection like this:"
								+ " 'f.object(\""
								+ level2Path()
								+ "\").from(<the projection on field "
								+ level2SingleValuedFieldPath()
								+ ">).as(...).multi()'."
				);
	}
	...
	public static final class DataSet<F, P, V extends AbstractProjectionTestValues<F, P>>
		...
		public DataSet(V values, ObjectStructure singleValuedObjectStructure,
			...
			super( values.fieldType.getUniqueName()
					+ "/single="
					+ singleValuedObjectStructure.name()
					+ "/multi="
					+ multiValuedObjectStructure, values );
		...
		public void contribute(SimpleMappedIndex<IndexBinding> mainIndex, BulkIndexer mainIndexer,
			...
			mainIndexer
					.add( docId( FULL_DOCUMENT_ID ), routingKey, document -> {
						...
						level1Object.addValue( level1.singleValuedField.get( values.fieldType ).reference, values
								.fieldValue( 0 ) );
						level1Object.addValue( level1.multiValuedField.get( values.fieldType ).reference, values
								.fieldValue( 1 ) );
						level1Object.addValue( level1.multiValuedField.get( values.fieldType ).reference, values
								.fieldValue( 2 ) );
						level1Object.addNullObject( level2.reference );
						level2Object = level1Object.addObject( level2.reference );
						level2Object.addValue( level2.singleValuedField.get( values.fieldType ).reference, values
								.fieldValue( 3 ) );
						level2Object.addValue( level2.multiValuedField.get( values.fieldType ).reference, values
								.fieldValue( 4 ) );
						level2Object.addValue( level2.multiValuedField.get( values.fieldType ).reference, values
								.fieldValue( 5 ) );
						level2Object = level1Object.addObject( level2.reference );
						...
						singleValuedLevel1Object.addValue( singleValuedLevel1.singleValuedField.get(
								values.fieldType ).reference, values.fieldValue( 18 ) );
						singleValuedLevel1Object.addValue( singleValuedLevel1.multiValuedField.get(
								values.fieldType ).reference, values.fieldValue( 19 ) );
						singleValuedLevel1Object.addValue( singleValuedLevel1.multiValuedField.get(
								values.fieldType ).reference, values.fieldValue( 20 ) );
					} )
					.add( docId( SINGLE_VALUED_DOCUMENT_ID ), routingKey, document -> {
						...
						singleValuedLevel1Object = document.addObject( singleValuedLevel1.reference );
						singleValuedLevel1Object.addValue( singleValuedLevel1.singleValuedField.get(
								values.fieldType ).reference, values.fieldValue( 4 ) );
						singleValuedLevel1Object.addValue( singleValuedLevel1.multiValuedField.get(
								values.fieldType ).reference, values.fieldValue( 5 ) );
					} )
					.add( docId( LEVEL1_SINGLE_OBJECT_DOCUMENT_ID ), routingKey, document -> {
						...
						singleValuedLevel1Object = document.addObject( singleValuedLevel1.reference );
						singleValuedLevel1Object.addValue( singleValuedLevel1.singleValuedField.get(
								values.fieldType ).reference, values.fieldValue( 9 ) );
						singleValuedLevel1Object.addValue( singleValuedLevel1.multiValuedField.get(
								values.fieldType ).reference, values.fieldValue( 10 ) );
						singleValuedLevel1Object.addValue( singleValuedLevel1.multiValuedField.get(
								values.fieldType ).reference, values.fieldValue( 11 ) );
					} )
			...
			missingLevel1SingleValuedFieldIndexer.add( docId( MISSING_LEVEL1_SINGLE_VALUED_FIELD_DOCUMENT_ID ),
					routingKey, document -> {
			...
			missingLevel2Indexer.add( docId( MISSING_LEVEL2_DOCUMENT_ID ), routingKey, document -> {
				...
				level1Object = document.addObject( level1.reference );
				level1Object.addValue( level1.singleValuedField.get( values.fieldType ).reference, values.fieldValue(
						0 ) );
				level1Object.addValue( level1.multiValuedField.get( values.fieldType ).reference, values.fieldValue(
						1 ) );
				level1Object.addValue( level1.multiValuedField.get( values.fieldType ).reference, values.fieldValue(
						2 ) );
			...
			missingLevel2SingleValuedFieldIndexer.add( docId( MISSING_LEVEL2_SINGLE_VALUED_FIELD_DOCUMENT_ID ),
					routingKey, document -> {
	...
	static class Level1ObjectWithFlattenedLevel2Dto<T> extends ObjectDto<T> {
		...
		Level1ObjectWithFlattenedLevel2Dto(T singleValuedField, List<T> multiValuedField, FlattenedObjectDto<
				T> level2) {
			super( singleValuedField, multiValuedField );
			this.level2 = level2;
		}
	...
	protected static class IndexBinding {
		...
		public Level1ObjectFieldBinding singleValuedLevel1(ObjectStructure structure) {
			return ObjectStructure.NESTED.equals( structure ) ?
					singleValuedLevel1_nested : singleValuedLevel1_flattened;
		}
	}
