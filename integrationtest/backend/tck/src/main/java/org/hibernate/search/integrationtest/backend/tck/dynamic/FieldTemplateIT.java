	...
	private <T> void initDocument(DocumentElement document, String fieldName,
		...
		switch ( fieldStructure.location ) {
			...
			case IN_NESTED_TWICE:
				...
				DocumentElement nestedNestedObject0 = firstLevelNestedObject0.addObject(
						binding.nestedObject.nestedObject.self );
				...
				DocumentElement nestedNestedObject1 = firstLevelNestedObject0.addObject(
						binding.nestedObject.nestedObject.self );
				...
				DocumentElement nestedNestedObject2 = firstLevelNestedObject1.addObject(
						binding.nestedObject.nestedObject.self );
