...
public class ObjectProjectionSpecificsIT {
	...
	private static class IndexBinding {
		...
		IndexBinding(IndexSchemaElement root) {
			...
			IndexSchemaObjectField flattenedObjectField = root.objectField( "flattenedLevel1",
					ObjectStructure.FLATTENED )
					.multiValued();
			flattenedLevel1 = new Level1ObjectBinding( flattenedObjectField );
			IndexSchemaObjectField otherNestedObjectField = root.objectField( "level1WithSingleValuedLevel2",
