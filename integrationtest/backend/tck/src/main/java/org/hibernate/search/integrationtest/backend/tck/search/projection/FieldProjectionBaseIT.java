...
public class FieldProjectionBaseIT {
	...
	public static class InObjectProjectionIT<F>
		...
		static {
			for ( FieldTypeDescriptor<?> fieldType : supportedFieldTypes ) {
				for ( ObjectStructure singleValuedObjectStructure : new ObjectStructure[] { ObjectStructure.FLATTENED,
					...
					DataSet<?, ?, ?> dataSet = new DataSet<>( testValues( fieldType ), singleValuedObjectStructure,
							multiValuedObjectStructure );
		...
		protected RecursiveComparisonConfiguration.Builder configureRecursiveComparison(
			...
			return builder.withComparatorForType( Comparator.nullsFirst( Comparator.naturalOrder() ),
					BigDecimal.class );
		}
