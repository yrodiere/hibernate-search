...
public class IndexableGeoPointWithDistanceFromCenterValues extends IndexableValues<GeoPoint> {
	...
	private final List<Double> singleDistancesFromCenterPoint1 = Collections.unmodifiableList(
			createDistancesFromCenterPoint1() );
	private final List<Double> singleDistancesFromCenterPoint2 = Collections.unmodifiableList(
			createDistancesFromCenterPoint2() );
