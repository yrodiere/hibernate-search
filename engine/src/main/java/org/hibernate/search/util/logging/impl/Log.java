...
public interface Log extends BasicLogger {
	...
	@Message(id = 331, value = "An 'entityManagerFactoryScope' was defined, but the 'entityManagerFactoryReference' parameter is empty."
	...
	@Message(id = 332, value = "No entity manager factory available in the CDI context with this bean name: '%1$s'."
	...
	@Message(id = 333, value = "Unknown entity manager factory scope: '%1$s'. Please use a supported scope.")
	SearchException unknownEntityManagerFactoryScope(String scopeName);

	@Message(id = 334, value = "Exception while retrieving the EntityManagerFactory using @PersistenceUnit."
	...
	@Message(id = 335, value = "Multiple entity manager factories have been registered in the CDI context."
	...
	@Message(id = 336, value = "No entity manager factory has been created with this persistence unit name yet: '%1$s'."
	...
	@Message(id = 337, value = "No entity manager factory has been created with this name yet: '%1$s'."
	...
	@Message(id = 338, value = "No entity manager factory has been created yet."
	...
	@Message(id = 339, value = "Multiple entity manager factories are currently active."
