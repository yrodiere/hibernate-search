...
public enum AgentType {
	...
	EVENT_PROCESSING_DYNAMIC_SHARDING, EVENT_PROCESSING_STATIC_SHARDING, MASS_INDEXING;

	public static final Set<AgentType> EVENT_PROCESSING =
			Collections.unmodifiableSet( EnumSet.of( EVENT_PROCESSING_DYNAMIC_SHARDING,
