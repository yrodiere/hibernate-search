...
class InitialPropertyMappingStep
	...
	public PropertyMappingGenericFieldOptionsStep genericField(String relativeFieldName) {
		PropertyMappingGenericFieldOptionsStepImpl child = new PropertyMappingGenericFieldOptionsStepImpl( this,
				relativeFieldName );
		children.add( child );
		return child;
	}
	...
	public PropertyMappingFullTextFieldOptionsStep fullTextField(String relativeFieldName) {
		PropertyMappingFullTextFieldOptionsStepImpl child = new PropertyMappingFullTextFieldOptionsStepImpl( this,
				relativeFieldName );
		children.add( child );
		return child;
	}
	...
	public PropertyMappingKeywordFieldOptionsStep keywordField(String relativeFieldName) {
		PropertyMappingKeywordFieldOptionsStepImpl child = new PropertyMappingKeywordFieldOptionsStepImpl( this,
				relativeFieldName );
		children.add( child );
		return child;
	}
	...
	public PropertyMappingScaledNumberFieldOptionsStep scaledNumberField(String relativeFieldName) {
		PropertyMappingScaledNumberFieldOptionsStepImpl child = new PropertyMappingScaledNumberFieldOptionsStepImpl(
				this, relativeFieldName );
		children.add( child );
		return child;
	}
