...
public class CompositeIdOrder implements IdOrder {
	...
	public Predicate idGreater(CriteriaBuilder builder, Root<?> root, Object idObj) {
		BiFunction<String, Object, Predicate> strictOperator = (String path, Object obj) -> builder.greaterThan( root
				.get( path ), (Comparable<? super Object>) idObj );
	...
	public Predicate idLesser(CriteriaBuilder builder, Root<?> root, Object idObj) {
		BiFunction<String, Object, Predicate> strictOperator = (String path, Object obj) -> builder.lessThan( root.get(
				path ), (Comparable<? super Object>) idObj );
		return restrictLexicographically( strictOperator, builder, root, idObj, false );
	}
