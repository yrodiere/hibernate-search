 ...
 *
 * Branches named "tracking-patch-<some-name>_<some-jenkins-job>_<some-other-jenkins-job>_<etc>"
...
class ScmBranch {
	...
	private static final Pattern TRACKING_PATTERN = ~/^tracking-patch-([^_]+)(?:_([^_]+))+$/
