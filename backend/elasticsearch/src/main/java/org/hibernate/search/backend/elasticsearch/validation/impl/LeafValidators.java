...
public final class LeafValidators {
	...
	private static final LeafValidator<JsonElement> JSON_ELEMENT_AS_DOUBLE_LEAF_VALIDATOR = new LeafValidator<
			JsonElement>() {
		@Override
	...
	private static final LeafValidator<JsonElement> JSON_ELEMENT_AS_FLOAT_LEAF_VALIDATOR = new LeafValidator<
			JsonElement>() {
		@Override
		protected void doValidate(ValidationErrorCollector errorCollector, JsonElement defaultedExpected,
				JsonElement defaultedActual, Object actual) {
