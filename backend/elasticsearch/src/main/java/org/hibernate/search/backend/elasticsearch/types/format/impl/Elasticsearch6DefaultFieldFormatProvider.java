...
public class Elasticsearch6DefaultFieldFormatProvider implements ElasticsearchDefaultFieldFormatProvider {
	...
	static {
		...
		map.put( Instant.class, asImmutableList( "yyyy-MM-dd'T'HH:mm:ss.SSS'Z'",
				"yyyyyyyyy-MM-dd'T'HH:mm:ss.SSSSSSSSS'Z'" ) );
		...
		map.put( LocalDateTime.class, asImmutableList( "yyyy-MM-dd'T'HH:mm:ss.SSS",
				"yyyyyyyyy-MM-dd'T'HH:mm:ss.SSSSSSSSS" ) );
		map.put( OffsetTime.class, asImmutableList( "HH:mm:ss.SSSZZ", "HH:mm:ss.SSSSSSSSSZZ" ) );
		map.put( OffsetDateTime.class, asImmutableList( "yyyy-MM-dd'T'HH:mm:ss.SSSZZ",
				"yyyyyyyyy-MM-dd'T'HH:mm:ss.SSSSSSSSSZZ" ) );
		/*
	...
	private DateTimeFormatter lenientPattern(String pattern) {
		...
		if ( fractionOfSecondsIndex < 0 ) {
			...
			return new DateTimeFormatterBuilder()
					...
					.appendPattern( pattern.substring( fractionOfSecondsIndex + JAVA_TIME_FRACTION_OF_SECONDS_PATTERN
							.length() ) )
