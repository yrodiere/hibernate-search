...
abstract class AbstractLuceneNumericIndexFieldTypeOptionsStep<
		S extends AbstractLuceneNumericIndexFieldTypeOptionsStep<S, F>,
		F>
	...
	public LuceneIndexValueFieldType<F> toIndexFieldType() {
		...
		if ( resolvedSortable ) {
			...
			builder.queryElementFactory( SortTypeKeys.FIELD, new LuceneStandardFieldSort.NumericFieldFactory<>(
					codec ) );
		}
